...
export interface SubagentRun { status: "running" | "success" | "error" | "aborted"; startedAt: number; finishedAt?: number; lastActivityAt?: number; items: SubagentItem[]; result?: string; error?: string; }
