...
const SUBAGENT_POLICY = "Researcher and worker calls return a runId immediately. Prefer independent work before bounded subagent_observe calls; do not continuously poll. If a run is healthy, observe again when needed. Cancel or redispatch narrower work when stalled, repeatedly failing, unnecessary, or over budget. Avoid modifying files owned by an active worker.";
