...
const SUBAGENT_POLICY = "Researcher and worker calls return a runId immediately. Do independent work before observing; use bounded subagent_observe calls and avoid repeated polling. Observe healthy runs again as needed. Cancel or redispatch narrower work when stalled, repeatedly failing, unnecessary, or over budget. Do not edit an active worker's targetFiles.";
